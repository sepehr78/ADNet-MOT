...
parser.add_argument('--weight_file', default='weights/ADNet_RL_downloaded.pth', type=str, help='The pretrained weight file')
...
parser.add_argument('--initial_samples', default=3000, type=int,
                    help='Number of training samples for the first frame. N_I')
parser.add_argument('--online_samples', default=250, type=int,
                    help='Number of training samples for the other frames. N_O')
...
parser.add_argument('--vid_index', default=1, type=str2bool, help='Index video whose weights to use (multidomain).')

parser.add_argument('--believe_score_result', default=0, type=int, help='Believe score result after n training')

parser.add_argument('--pos_samples_ratio', default='0.7', type=float,
