...
opts = {
    ...
    'nFrames_long': 100,
    # long-term period (in matlab code, for positive samples... while current implementation just with history for now...)
    ...
    'means': [104, 117, 123]
    # https://github.com/amdegroot/ssd.pytorch/blob/8dd38657a3b1df98df26cf18be9671647905c2a0/data/config.py
